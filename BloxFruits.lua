...
-- print("--------------------------------------------------------------------------");
local Update = (loadstring(Game:HttpGet("https://raw.githubusercontent.com/Ndraawz/NdraawSirius/refs/heads/main/bloxfruit1.lua")))();
...
function Hop()
	local module = (loadstring(game:HttpGet("https://raw.githubusercontent.com/Ndraawz/NdraawSirius/refs/heads/main/bf1serverhop.lua")))();
...
ServTab:Button("Server Hop", function()
	while wait(0.2) do
		local module = (loadstring(game:HttpGet("https://raw.githubusercontent.com/Ndraawz/NdraawSirius/refs/heads/main/bfhop2.lua")))();
